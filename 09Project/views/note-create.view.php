...
<div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
    <form method="post" class="space-y-6">
        ...
        <div class="flex flex-col">
            ...
            <textarea id="body" name="body" rows="6" class="mt-2 p-4 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none"></textarea>
        </div>
